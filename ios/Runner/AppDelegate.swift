...
@objc class AppDelegate: FlutterAppDelegate {
  override func application(
    ...
    let channel = FlutterMethodChannel(name: "live_activities", binaryMessenger: controller.binaryMessenger)
          ...
          if #available(iOS 16.1, *) {
            ...
            case "updateActivity":
              ...
              if let activityId = args["activityId"] as? String, let data = args["data"] as? Dictionary<String, String> {
                  self?.updateActivity(activityId: activityId, data: data, result: result)
              } else {
            ...
            case "endActivity":
              ...
              if let activityId = args["activityId"] as? String {
                  self?.endActivity(activityId: activityId, result: result)
              } else {
